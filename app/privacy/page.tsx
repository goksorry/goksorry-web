...
export default function PrivacyPage() {
  return (
    <section className="panel legal-page">
      ...
      <p>
        다만 로그인 처리를 위해 Google OAuth, 인증 및 데이터 저장을 위해 Supabase, 서비스 배포를 위해 Vercel을 이용하며,
        이 과정에서 서비스 운영에 필요한 범위 내의 처리가 발생할 수 있습니다.
      </p>

      <h2>5. 이용자의 권리</h2>
      <p>이용자는 자신의 개인정보에 대해 열람, 정정, 삭제, 처리정지를 요청할 수 있습니다.</p>
      <p>권리 행사는 admin@goksorry.com으로 문의하시면 됩니다.</p>
